...
//  }
   ...
   * @return
   */
  @RequestMapping(value = SEARCH_FORM_URL, method = {RequestMethod.GET})
  public String searchPage(Model model) {
    ...
    //新規登録、更新、削除画面から戻ってきた場合それぞれに対応した文字列が格納されている
    //forwordで遷移してきた場合 HttpServletRequestからでないと取り出せない
  ...
  public String add(Model model) {
    ...
    return "forward:" + SEARCH_FORM_URL;
  }
